...
These codes are under revision and being made public accordingly. Please check the HTML file "HowtoCMAP.html" in the docs folder for a demonstration of the input dataset and an example of an R script to use CMAP (you may need to download it). Please create an Issue (https://github.com/marianesreis/CMAP/issues) or contact me at mariane.reis@inpe.br for more information and/or suggestions.
